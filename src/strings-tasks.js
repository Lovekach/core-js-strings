...
function extractNameFromTemplate(value) {
  ...
  return match ? match[1] : ''; // Return the captured name or an empty string if no match
}
...
function unbracketTag(str) {
  ...
  return str; // Return the string as is if it doesn't start and end with angle brackets
}
